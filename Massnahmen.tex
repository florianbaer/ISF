...
\begin{landscape}
	...
	\begin{tabularx}{\columnwidth}{|r|c|X|c|X|c|c|}
		...
		2 &  \cellcolor{green}1 & Spiele können trotzdem ungewollt Ports eines Systemes öffnen und damit ein Risiko darstellen. Zudem könne Mods Sicherheitslücken beinhalten und ein Problem darstellen. Das Risiko, welches Cracks mitbringen ist allerdings eliminiert. & \cellcolor{yellow}2 & Das Risiko, welches von gekaufter Software ausgeht ist mit Massnahme (3) gelöst & \cellcolor{green}2 & \cellcolor{green} Ja  \\ \hline
		
		3 &  \cellcolor{yellow}2 & Mods und kleinere Informatik-Tools welche Schadcode enthalten können, werden von einem Virenscanner frühzeitig erkannt und eliminiert. & \cellcolor{green}1 & Falls trotzdem eine Schadsoftware aufgrund der Dateisignatur unerkannt bleiben sollte, dann erkennt ein Antivirus anhand von Verhaltensmustern die Schadsoftware und der Schaden bleibt gering. & \cellcolor{green}2 & \cellcolor{green} Ja \\ \hline

		4 &  \cellcolor{green}1 & Dora kann nun keine unerwünschte Software mehr installieren und von ihr geht somit keine Gefahr mehr aus. & \cellcolor{yellow}2 & Dora kann die Computer im eigenen Netzwerk nicht mehr infizieren und somit keinen Schaden verursachen.  & \cellcolor{green}2 & \cellcolor{green} Ja  \\ \hline
		
		5 &  \cellcolor{yellow}2 & Es ist immernoch Möglich, dass eine Disk oder ein Computer kaputt geht. Auch wenn eine Disk auf dem NAS kaputt geht, besteht kein Schaden, da auf dem NAS ein RAID 6 konfiguriert ist. & \cellcolor{green}1 & Falls eine Harddisk kaputt geht, sind Backups der jeweiligen Systeme vorhanden welche zurückgespielt werden können. & \cellcolor{green}1 & \cellcolor{green} Ja  \\ \hline
